...
void edgeNearBottom(in ivec3 brickAddress) {
  ...
  //  1/4
  float weight = 0.25;
  avgColor(0, ivec3(2, 0, 0), weight, weightSum, color);
  // weightSum += weight;                         
...
void edgeNearRight(in ivec3 brickAddress) {
  ...
  //  1/4
  float weight = 0.25;
  avgColor(1, ivec3(2, 2, 0), weight, weightSum, color);
  // weightSum += weight;                                
...
void edgeNearLeft(in ivec3 brickAddress) {
  ...
  //  1/4
  float weight = 0.25;
  avgColor(0, ivec3(0, 2, 0), weight, weightSum, color);
  // weightSum += weight;                                
...
void edgeNearTop(in ivec3 brickAddress) {
  ...
  //  1/4
  float weight = 0.25;
  avgColor(2, ivec3(2, 2, 0), weight, weightSum, color);
  // weightSum += weight;                         
...
void edgeFarBottom(in ivec3 brickAddress) {
  ...
  //  1/4
  float weight = 0.25;
  avgColor(4, ivec3(2, 0, 2), weight, weightSum, color);
  // weightSum += weight;                         
...
void edgeFarTop(in ivec3 brickAddress) {
  ...
  //  1/4
  float weight = 0.25;
  avgColor(6, ivec3(2, 2, 2), weight, weightSum, color);
  // weightSum += weight;                         
...
void edgeFarLeft(in ivec3 brickAddress) {
  ...
  //  1/4
  float weight = 0.25;
  avgColor(4, ivec3(0, 2, 2), weight, weightSum, color);
  // weightSum += weight;                                
...
void edgeFarRight(in ivec3 brickAddress) {
  ...
  //  1/4
  float weight = 0.25;
  avgColor(5, ivec3(2, 2, 2), weight, weightSum, color);
  // weightSum += weight;                                
...
void edgeLeftBottom(in ivec3 brickAddress) {
  ...
  //  1/4
  float weight = 0.25;
  avgColor(0, ivec3(0, 0, 2), weight, weightSum, color);
  // weightSum += weight;                         
...
void edgeRightBottom(in ivec3 brickAddress) {
  ...
  //  1/4
  float weight = 0.25;
  avgColor(1, ivec3(2, 0, 2), weight, weightSum, color);
  // weightSum += weight;                         
...
void edgeLeftTop(in ivec3 brickAddress) {
  ...
  //  1/4
  float weight = 0.25;
  avgColor(2, ivec3(0, 2, 2), weight, weightSum, color);
  // weightSum += weight;                         
...
void edgeRightTop(in ivec3 brickAddress) {
  ...
  //  1/4
  float weight = 0.25;
  avgColor(3, ivec3(2, 2, 2), weight, weightSum, color);
  // weightSum += weight;                         
